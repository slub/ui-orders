...
export const getPoLineFieldsLabelMap = ({
  ...
  return {
    ...
    'paymentTerms.fiscalYearDistributions[\\d].fiscalYearId': 'ui-orders.poLine.versionHistory.paymentTerms.fiscalYearDistributions.fiscalYear',
    'paymentTerms.fiscalYearDistributions[\\d].fundDistributions': 'ui-orders.poLine.versionHistory.paymentTerms.fiscalYearDistributions',
    'paymentTerms.fiscalYearDistributions[\\d].fundDistributions[\\d]': 'ui-orders.poLine.versionHistory.paymentTerms.fiscalYearDistributions',
    'paymentTerms.fiscalYearDistributions[\\d].fundDistributions[\\d].fundId': 'ui-orders.poLine.versionHistory.paymentTerms.fiscalYearDistributions.fund',
    'paymentTerms.fiscalYearDistributions[\\d].fundDistributions[\\d].code': 'ui-orders.poLine.versionHistory.paymentTerms.fiscalYearDistributions.fund',
    'paymentTerms.fiscalYearDistributions[\\d].fundDistributions[\\d].expenseClassId': 'ui-orders.poLine.versionHistory.paymentTerms.fiscalYearDistributions.expenseClass',
    'paymentTerms.fiscalYearDistributions[\\d].fundDistributions[\\d].value': 'ui-orders.poLine.versionHistory.paymentTerms.fiscalYearDistributions.value',
    'paymentTerms.fiscalYearDistributions[\\d].fundDistributions[\\d].distributionType': 'ui-orders.poLine.versionHistory.paymentTerms.fiscalYearDistributions.distributionType',
